...
describe('qc-to_int', () => {
  ...
  describe('`toInt`', () => {
    ...
    it('called with inconvertible input should return default value', function () {
      ...
      def = [];
      expect(toInt([], def)).toBe(def);
      expect(toInt([], { def })).toBe(def);
      expect(toInt(['not empty'], def)).toBe(def);
      expect(toInt(['not empty'], { def })).toBe(def);
      expect(toInt(true, def)).toBe(def);
      expect(toInt(true, { def })).toBe(def);
      expect(toInt(false, def)).toBe(def);
      expect(toInt(false, { def })).toBe(def);
      expect(toInt(new Error('Help!'), def)).toBe(def);
      expect(toInt(new Error('Help!'), { def })).toBe(def);
      expect(toInt(function () {}, def)).toBe(def);
      expect(toInt(function () {}, { def })).toBe(def);
      expect(toInt(arguments, def)).toBe(def);
      expect(toInt(arguments, { def })).toBe(def);
      expect(toInt(NaN, def)).toBe(def);
      expect(toInt(NaN, { def })).toBe(def);
      expect(toInt(Number.NaN, def)).toBe(def);
      expect(toInt(Number.NaN, { def })).toBe(def);
      expect(toInt({}, def)).toBe(def);
      expect(toInt({}, { def })).toBe(def);
      expect(toInt({ prop: 'not empty' }, def)).toBe(def);
      expect(toInt({ prop: 'not empty' }, { def })).toBe(def);
      expect(toInt(/regexp/, def)).toBe(def);
      expect(toInt(/regexp/, { def })).toBe(def);
      expect(toInt('', def)).toBe(def);
      expect(toInt('', { def })).toBe(def);
      expect(toInt('not empty', def)).toBe(def);
      expect(toInt('not empty', { def })).toBe(def);
      expect(toInt(null, def)).toBe(def);
      expect(toInt(null, { def })).toBe(def);
      expect(toInt(undefined, def)).toBe(def);
      expect(toInt(undefined, { def })).toBe(def);
      ...
      def = NaN;
      expect(toInt([], def)).toEqual(NaN);
      expect(toInt([], { def })).toEqual(NaN);
      expect(toInt(['not empty'], def)).toEqual(NaN);
      expect(toInt(['not empty'], { def })).toEqual(NaN);
      expect(toInt(true, def)).toEqual(NaN);
      expect(toInt(true, { def })).toEqual(NaN);
      expect(toInt(false, def)).toEqual(NaN);
      expect(toInt(false, { def })).toEqual(NaN);
      expect(toInt(new Error('Help!'), def)).toEqual(NaN);
      expect(toInt(new Error('Help!'), { def })).toEqual(NaN);
      expect(toInt(function () {}, def)).toEqual(NaN);
      expect(toInt(function () {}, { def })).toEqual(NaN);
      expect(toInt(arguments, def)).toEqual(NaN);
      expect(toInt(arguments, { def })).toEqual(NaN);
      expect(toInt(NaN, def)).toEqual(NaN);
      expect(toInt(NaN, { def })).toEqual(NaN);
      expect(toInt(Number.NaN, def)).toEqual(NaN);
      expect(toInt(Number.NaN, { def })).toEqual(NaN);
      expect(toInt({}, def)).toEqual(NaN);
      expect(toInt({}, { def })).toEqual(NaN);
      expect(toInt({ prop: 'not empty' }, def)).toEqual(NaN);
      expect(toInt({ prop: 'not empty' }, { def })).toEqual(NaN);
      expect(toInt(/regexp/, def)).toEqual(NaN);
      expect(toInt(/regexp/, { def })).toEqual(NaN);
      expect(toInt('', def)).toEqual(NaN);
      expect(toInt('', { def })).toEqual(NaN);
      expect(toInt('not empty', def)).toEqual(NaN);
      expect(toInt('not empty', { def })).toEqual(NaN);
      expect(toInt(null, def)).toEqual(NaN);
      expect(toInt(null, { def })).toEqual(NaN);
      expect(toInt(undefined, def)).toEqual(NaN);
      expect(toInt(undefined, { def })).toEqual(NaN);
